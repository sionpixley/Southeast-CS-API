...
urlpatterns = [
    ...
    path("add-article/", views.add_course),
    path("get-article-by-id/<int:id>/", views.get_course_by_id),
    path("get-all-articles/", views.get_all_courses),
    path("edit-article-by-id/<int:id>/", views.edit_course_by_id),
    path("remove-article-by-id/<int:id>/", views.remove_course_by_id),
